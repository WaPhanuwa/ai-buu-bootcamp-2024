...
ACCESS_TOKEN = os.getenv("LINE_ACCESS_TOKEN", "OVUDxiVdVspThgJzeRpoEQ/bOb6jazWOt7dcUUFOmRx5qPTgMLdzHALCHpx67q44e5ZgQjzScJ8d9P6btcERMk2L4lK4Xah4EfghY5mVlGPnoNJdjGxN7YMGD7kaL3t4U9gWFB3nBwDhURGIbma6yAdB04t89/1O/w1cDnyilFU=")
CHANNEL_SECRET = os.getenv("LINE_CHANNEL_SECRET", "3e25b3b082f374ce13c5d029b6a11250")

# ข้อมูล Gemini api key
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyA8HadE2xYWBbsiDiTBpJUoF5pUIrM799Q")
...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "ภานุวัตร คือ ชายหนุ่มที่มีความสามารถในการเขียนโปรแกรมที่มาจากบริษัท ClickNext ที่เป็นบริษัทด้านการพัฒนาโปรแกรมที่มีชื่อเสียง",
        "ภานุวัตร ทำดี มีชื่อเล่นว่า ว้า เกิดวันที่ 13 สิงหาคม 2546 ที่จังหวัดปราจีนบุรี ศึกษาจบจากมหาวิทยาลัยบูรพา สาขาวิศวกรรมคอมพิวเตอร์",
        ...
        "ClickNext team AI มีใครบ้าง และมีหน้าที่อะไรบ้าง 1.พี่ปาล์ม = Backend 2.พี่ชวน = DataOps = Automation + Monitoring + Testing. 3.พี่ออย = BA 4.พี่เจ๋ง = fronะend 5.พี่ดาว = BA"
    ]
