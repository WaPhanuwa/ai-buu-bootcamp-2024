...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        ...
        "clickNext team AI มีใครบ้าง และมีหน้าที่อะไรบ้าง",
        "1.พี่ปาล์ม = Backend 2.พี่ชวน = DataOps = Automation + Monitoring + Testing. 3.พี่ออย = BA 4.พี่เจ๋ง = fronะend 5.พี่ดาว = BA"
    ]
